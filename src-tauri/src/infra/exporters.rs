...
pub(crate) const DEFAULT_EXPORT_LIMITS: ExportLimits = ExportLimits {
    ...
    max_pdf_pages_per_item: DEFAULT_PDF_PAGES_PER_ITEM,
    max_pdf_pages_total: 500,
    max_pdf_objects_per_item: DEFAULT_PDF_OBJECTS_PER_ITEM,
    max_pdf_objects_total: 100_000,
    max_pdf_decoded_stream_bytes_per_item: DEFAULT_PDF_DECODED_STREAM_BYTES_PER_ITEM,
...
pub(crate) fn prepare_merged_pdf(
    ...
    let pdf_limits = PdfResourceLimits::new(
        limits.max_pdf_pages_per_item,
        limits.max_pdf_pages_total,
        limits.max_pdf_objects_per_item,
        limits.max_pdf_objects_total,
        limits.max_pdf_decoded_stream_bytes_per_item,
        limits.max_pdf_decoded_stream_bytes_total,
    );
    ...
    for item in items {
        ...
        validate_pdf_structure_with_limit(&raw_pdf, limits.max_pdf_objects_per_item)
            .map_err(PdfPreflightError::into_validation_error)?;
...
mod tests {
    ...
    use super::{exact_xlsx_amount, validate_xlsx_text};
